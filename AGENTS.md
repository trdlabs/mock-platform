...
- **Entry points:** `scripts/verify_contract_isolation.ts`, `scripts/verify_no_secrets.ts`, `src/bin/start-research-mcp.ts`, `scripts/verify_sdk_pin.ts`, `src/bin/start-mock-ops.ts`
